...
- Do NOT include background, education, or platform explanations unless it is related to the problem description
...
"""
GENERIC_RESOLUTION_GUIDANCE_ANALYZER = """
...
def get_kb_context_analyzer(case_key=None, max_articles=3):
    if not case_key:
        return ""
