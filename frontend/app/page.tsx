...
>
  ...
  <option value="duplicate_profile">
  ...
  <option value="share_bank">
    Share bank with customer
  </option>

  <option value="2FA_reset">
    Reset 2FA method
  </option>
  ...
  <option value="Task_completed">
    Task completed but not cleared
  </option>

  <option value="add_new_users">
    Add new users
  </option>

  <option value="password_update">
    Password reset
  </option>
